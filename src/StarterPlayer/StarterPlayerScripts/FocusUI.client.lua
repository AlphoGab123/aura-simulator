...
local rebirthsLabel = createLabel(
    "RebirthsLabel",
    "Rebirths: 0",
    UDim2.new(0.5, -170, 1, -40),
    screenGui
)
rebirthsLabel.TextSize = 12
rebirthsLabel.TextColor3 = Color3.fromRGB(200, 230, 255)
...
focusUpdateEvent.OnClientEvent:Connect(function(focusValue, multiplier, rebirths)
    updateUI(focusValue)
    updateMultiplier(multiplier)
    updateRebirths(rebirths)
end)
